...
import it.legacynetwork.screenshare.message.ChatSegment;
 ...
 *
 * <p>Il testo arriva da NetworkLanguage, i colori dai codici {@code &} usati nel
 * resto della rete; qui si aggiungono soltanto i comportamenti.</p>
 */
public final class AdventureRenderer {
    ...
    public static Component render(ChatSegment segment) {
        ...
        if (segment.getRunCommand().isPresent()) {
            ...
            component = component.clickEvent(ClickEvent.suggestCommand(

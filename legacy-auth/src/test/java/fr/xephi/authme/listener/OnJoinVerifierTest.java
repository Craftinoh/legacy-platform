...
public class OnJoinVerifierTest {
    ...
    public void shouldKickNonVipForJoiningVipPlayer() {
        ...
        // The kick message is shown to the kicked player, so it is resolved in their language
        given(messages.retrieveSingle(onlinePlayers.get(1), MessageKey.KICK_FOR_VIP)).willReturn("kick for vip");

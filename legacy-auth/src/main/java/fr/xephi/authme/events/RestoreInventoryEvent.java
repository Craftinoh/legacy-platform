 ...
 *
 * @deprecated LegacyAuth removed the inventory hiding feature, so this event is never fired any
 *             more. The class is retained so that plugins compiled against AuthMe 5.6.0 still
 *             link against it; it will be removed in a future major release.
 */
@Deprecated

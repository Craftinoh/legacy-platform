    ...
    public void onAsyncPlayerPreLoginEventLowest(AsyncPlayerPreLoginEvent event) {
        ...
        if (event.getAddress() == null) {
            event.disallow(AsyncPlayerPreLoginEvent.Result.KICK_OTHER,
                messages.retrieveSingle(event.getUniqueId(), name, MessageKey.KICK_UNRESOLVED_HOSTNAME));
            return;
        }
        ...
        try {
            ...
            event.setKickMessage(messages.retrieveSingle(event.getUniqueId(), name, e.getReason(), e.getArgs()));

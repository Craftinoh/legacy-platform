...
public final class RestrictionSettings implements SettingsHolder {
    ...
    // LegacyAuth: settings.restrictions.ProtectInventoryBeforeLogIn was removed together with the
    // inventory hiding feature. The key is simply ignored if still present in an existing config.yml.

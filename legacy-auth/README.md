> ## ⚠️ This is a fork, not official AuthMeReloaded
>
> **Apteris AuthMe** is an unofficial fork of
> [AuthMe/AuthMeReloaded](https://github.com/AuthMe/AuthMeReloaded), branched from tag
> **5.6.0** (commit `107be9ab083ab43b7ff533ad3155f7fe29fb3b0f`). It adds per-player message
> languages; everything else is upstream code.
>
> Do **not** report issues with this build to the AuthMe team — they did not write these changes.
> The fork remains licensed under **GPL-3.0**, and all upstream copyright and licence notices are
> kept intact. See [FORK.md](FORK.md) for what was changed and why.
